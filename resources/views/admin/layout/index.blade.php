  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href=""><i class="fa fa-circle-o"></i> Tiêu đề chung</a></li>
          <li><a href=""><i class="fa fa-circle-o"></i> Thêm căn hộ</a></li>
      ...
      <li><a href=""><i class="fa fa-building"></i> <span>Danh sách khách hàng </span>
        ...
        <li class="treeview">
          <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href=""><i class="fa fa-circle-o"></i>Thông tin liên hệ chi tiết</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i>Thêm địa chỉ đường dẫn <br> đến website</a></li>
            </ul>
          </li>


          <li><a href=""><i class="fa  fa-envelope"></i> <span>Mẫu email tự động gửi <p style="text-align: center">khách hàng</p><span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
